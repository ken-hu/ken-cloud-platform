...
insert into db_usercenter.t_uc_role(id, name, `desc`)
values (1, 'root', '管理员');

insert into db_usercenter.t_uc_permission(id, name, `desc`)
values (1, '测试权限', '测试权限');

insert into db_usercenter.t_uc_resource(id, name, `desc`, resource_type, resource_key, ext_info)
...
insert into db_usercenter.t_uc_user_role_rel(id, user_id, role_id)
values (1, 1, 1);

insert into db_usercenter.t_uc_role_permission_rel(id, role_id, permission_id)
values (1, 1, 1);

insert into db_usercenter.t_uc_permission_resource_rel(id, permission_id, resource_id)
values (1, 1, 1),
       (1, 1, 2);